...
export const SimOrderRadio = ({ radioCheckedSIM, setSingleField, isSideSheet }: Props) => {
    return (
        <>
            <Grid item xs={10} sm={10} md={isSideSheet ? 11 : 5}>
            ...
            <Grid container item xs={12} spacing={3}>
                <Grid item xs={10} sm={6} md={isSideSheet ? 6 : 3} data-testid={'wifi_radio_button'}>
                    <Radio
                        label="No, WIFI only"
                        value="wifi"
                ...
                <Grid item xs={10} sm={6} md={isSideSheet ? 6 : 3} data-testid={'4g_radio_button'}>
                    <Radio
